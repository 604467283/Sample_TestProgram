...
namespace Liteon_TestProgram.TestFunc.ACE
{
    internal class RFTestResult
    {
        ...
        public string Power_ExpectedOrUsed { get; set; }
        ...
        public class WifiMetrics_Tx
        {
            ...
            public string SpectrumMask { get; set; }
            public string SpectrumMask_Range { get; set; }
            public string SpectrumMask_Result { get; set; }
