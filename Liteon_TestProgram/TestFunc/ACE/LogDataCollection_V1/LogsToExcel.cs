    ...
    internal class LogsToExcel
    {
        ...
        private void AppendDataToStreamWriter(RFTestResult result, StreamWriter sw, TestConfiguration LogCollectConfig)
        {
            ...
            if (result.Metrics_Tx != null)
            {
                ...
                //AppendMetricData(sb, result, "SpectrumMask", result.Metrics_Tx.SpectrumMask, result.Metrics_Tx.SpectrumMask_Range, result.Metrics_Tx.SpectrumMask_Result);
                if (LogCollectConfig.Wifi.SpectrumMask)
                {
                    string range = LogCollectConfig.Standard ? result.Metrics_Tx.SpectrumMask_Range : "EMPTY";
                    string resultText = LogCollectConfig.Result ? result.Metrics_Tx.SpectrumMask_Result : "EMPTY";

                    AppendMetricData(sb, result, "SpectrumMask", result.Metrics_Tx.SpectrumMask, range, resultText);
                }
            ...
            {
                //AppendMetricData(sb, result, "Rx_Power", result.Power_ExpectedOrUsed, "EMPTY", "EMPTY");
        ...
        private void AppendTitelToStreamWriter(RFTestResult result, StreamWriter sw, TestConfiguration LogCollectConfig)
        {
            ...
            if (result.Metrics_Tx != null)
            {
                ...
                //AppendMetricTitel(sb, result, "SpectrumMask", "SpectrumMask_Range", "SpectrumMask_Result");
                if (LogCollectConfig.Wifi.SpectrumMask)
                {
                    string range = LogCollectConfig.Standard ? "SpectrumMask_Range" : "";
                    string resultText = LogCollectConfig.Result ? "SpectrumMask_Result" : "";

                    AppendMetricTitel(sb, result, "SpectrumMask", range, resultText);
                }
