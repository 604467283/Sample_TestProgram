...
namespace Liteon_TestProgram.TestFunc.iTest
{
    internal class RFTestResult
    {
        ...
        public class WifiMetrics_Tx
        {
            ...
            public string MaskErr { get; set; }
            public string MaskErr_Range { get; set; }
            public string MaskErr_Result { get; set; }
        ...
        {
            public string InitFreqErr { get; set; }
            public string InitFreqErr_Range { get; set; }
            public string InitFreqErr_Result { get; set; }
