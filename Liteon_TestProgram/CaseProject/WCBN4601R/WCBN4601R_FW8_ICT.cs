...
{
    internal class WCBN4601R_FW8_ICT : Base_ICT
    {
        ...
        /// </summary>
        protected override string str_ICTFlowMark { get; set; } = "250716";
        ...
        /// 用于读取ICT测试数据返回的超时时间 ms
        /// </summary>
        protected override int iICTTestFlowImportTimeout { get; set; } = 15000;
        ...
        public WCBN4601R_FW8_ICT(MainForm mf, TestForm tf, ProjectChangeForm pc, string str_CaseProject)
        ...
        public override void Func_TestMac()
        {
            ...
            {
                struct_TestVariable.iMAC_OriginalLength = 42;
                struct_TestVariable.iMAC_ExtractStartPosition = 17;
                struct_TestVariable.iMACLength = 12;

                struct_TestVariable.iBD_OriginalLength = 42;
                struct_TestVariable.iBD_ExtractStartPosition = 17;
