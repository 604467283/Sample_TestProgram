...
using Liteon_TestProgram.TestFunc.ACE.LogDataCollection_V1;
using static Liteon_TestProgram.Base.Class_Variable;

namespace Liteon_TestProgram.CaseProject
{
    internal class ZLogDataCollection_ACE_V1 : ZLogDataCollection_Litepoint_V1
    {

        public ZLogDataCollection_ACE_V1(MainForm mf, TestForm tf, ProjectChangeForm pc, string str_CaseProject)
