...
{
    internal class ZLogDataCollection_Litepoint_V2: ZLogDataCollection_Litepoint_V1
    {

        public ZLogDataCollection_Litepoint_V2(MainForm mf, TestForm tf, ProjectChangeForm pc, string str_CaseProject)
