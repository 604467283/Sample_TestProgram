...
{
    internal class WCBN811L_L6_BE_LSSC_ICT : Base_ICT
    {
        ...
        /// </summary>
        protected override string str_MacPrefix { get; set; } = "23S";

        /// <summary>
        /// 用于添加MAC的后缀，比如“A”，默认是空
        /// </summary>
        protected override string str_MacSuffix { get; set; } = "";
        ...
        public WCBN811L_L6_BE_LSSC_ICT(MainForm mf, TestForm tf, ProjectChangeForm pc, string str_CaseProject)
