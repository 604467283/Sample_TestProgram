...
{
    internal class WCBN3602M_SA_WH_LabelCheck : CaseCodeBase
    {
        ...
        public WCBN3602M_SA_WH_LabelCheck(MainForm mf, TestForm tf, ProjectChangeForm pc, string str_CaseProject)
        ...
        public override List<string> CreateChangeStringList()
        {
            ...
            list_str.Add("1.此程式用于检查有壳有线束 label check\r\n");
            list_str.Add("2.然后依次扫码, 点击测试\r\n");
            list_str.Add("3.修改电源供电方式为直流稳压电源，并程控.");
